...
const blogPosts = [
  ...
  { slug: 'how-much-does-social-media-marketing-cost-canada', contentExcerpt: 'One of the most common questions we hear from business owners across Canada is simple: "How much does social media marketing actually cost?" It\'s a fair question — and unfortunately, the answer you\'ll get from most agencies is vague at best. At AP DIGITAL, we believe in transparency, so let\'s break it down honestly.', metaTitle: 'How Much Does Social Media Marketing Cost in Canada? | AP Digital', metaDescription: 'Transparent breakdown of social media marketing costs for Canadian businesses — agency fees, ad spend & what to expect at every price point.', date: '2026-03-12', category: 'Marketing Strategy' },
