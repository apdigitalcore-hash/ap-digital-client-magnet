...
const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'web',
    niche: 'Construction',
    description: 'Professional website showcasing projects, services, and generating commercial leads.',
    challenge: 'No online presence, losing large commercial contracts to competitors with professional websites.',
    solution: 'Built a stunning portfolio-driven website with project galleries, testimonials, and lead capture forms.',
    results: ['$2.1M in new contracts', '85% more RFQ submissions', 'Featured in industry publication'],
  ...
  },
  {
    ...
    description: 'Modern, patient-friendly website with online booking and service pages.',
    challenge: 'Outdated website failing to attract new patients in a competitive urban market.',
    solution: 'Designed a warm, welcoming website with virtual office tours, patient reviews, and seamless appointment booking.',
    results: ['200+ new patients in 6 months', '4.9★ Google rating', '35% more appointment bookings'],
