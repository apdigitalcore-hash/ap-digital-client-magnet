    ...
    <main className="min-h-screen bg-near-black">
      ...
      <section id="compare" className="py-16 sm:py-24 bg-near-black">
        <div className="container-custom max-w-5xl">
          ...
          <div className="overflow-x-auto rounded-2xl border border-gray-800 bg-charcoal-light/40">
            <table className="w-full min-w-[640px]">
              ...
              <tbody>
                {compareRows.map((row, i) => (
                  <tr
                    key={row.feature}
                    className={`${i % 2 === 0 ? 'bg-charcoal-light/20' : ''} border-b border-gray-800/50 last:border-b-0`}
                  >
                    ...
                    <td className="px-5 py-3.5 text-center bg-teal/5">
