      ...
      <div className="container-custom max-w-4xl">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-16">
          ...
          <div className="group reveal-card relative overflow-hidden bg-white elev-2 hover:elev-3 hover:-translate-y-1 rounded-3xl transition-all duration-300 p-6">
            ...
            <p className="reveal-body relative z-10 text-sm text-muted-foreground">No contracts. If we miss the lead target we agree on in 90 days, we keep working free until we hit it. Month-to-month, always.</p>
          </div>
        </div>
