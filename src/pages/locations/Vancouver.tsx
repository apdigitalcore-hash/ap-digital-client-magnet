...
const TITLE = 'Google & Meta Ads Vancouver — From $759/mo, No Contract';
...
const faqs = [
  {
    question: 'Who is the best digital marketing agency in Vancouver for contractors?',
    answer: 'For Vancouver trades — plumbers, HVAC, electricians, roofers — the agency worth hiring is the one that targets at neighbourhood level rather than blanketing Metro Vancouver, and that reports cost per booked job rather than impressions. AP Digital runs Google Ads and Meta Ads for Vancouver contractors across Kitsilano, Mount Pleasant, East Vancouver and Yaletown, month-to-month with no lock-in. Arjun Sharma manages every account personally, so the person building your campaign is the person you talk to.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Paid ads management is $759/month and social media management is $849/month, quoted separately so you only pay for what you use. Ad spend is separate again and goes straight to Google or Meta, so you keep control of the budget. Most Vancouver businesses start between $1,000 and $2,000/month all in.',
  },
  {
    ...
    <main id="main-content">
      ...
      <section className="py-16 bg-white border-t border-foreground/[0.07]">
        <div className="container-custom max-w-3xl text-muted-foreground leading-relaxed">
          <h2 className="font-serif text-2xl text-foreground mb-4">More on working with us in Vancouver</h2>
          <p className="mb-4">
